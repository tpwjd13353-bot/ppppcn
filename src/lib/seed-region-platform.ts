  ...
  const platforms = [
    {
      ...
      icon: "📕",
      descTemplate:
        '중국 MZ의 라이프스타일 검색 채널입니다. {{top_menus}}처럼 매장 시그니처 메뉴를 비주얼이 살아있는 노트로 정리하면 "이 지역 OO 맛집"으로 검색 노출되기 좋은 구조입니다. 지역+메뉴 해시태그 조합이 핵심입니다.',
      lockedTeaser:
    ...
    },
    {
      ...
      icon: "⭐",
      descTemplate:
        "사진을 본 후 매장 방문 결심으로 이어지는 단계입니다. {{top_menus}} 같은 절대선호 메뉴를 대표 이미지로 노출하고, 단체석·세트 구성으로 객단가를 운영합니다. 별점·리뷰가 검색 노출 순위에 영향을 주는 구조로 알려져 있습니다.",
      lockedTeaser:
    ...
    },
    {
      ...
      icon: "🎬",
      descTemplate:
        "짧은 영상의 도달이 크게 작동하는 채널입니다. {{top_menus}}의 조리·서빙 컷이나 손님 반응 컷을 15초 안팎의 클립으로 구성하면 매장 인지도 형성에 도움이 됩니다. 거주 중국인의 지인 공유 흐름까지 고려해 콘텐츠를 설계합니다.",
      lockedTeaser:
