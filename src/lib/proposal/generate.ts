...

{
  ...
  "diagnosis": {
    "strength": "(강점 박스 본문. **최대 3줄·150자 이내**, \\n 으로 줄바꿈. 핵심만 압축. 그리드 한 칸 폭에 맞춰야 함)",
    "current": "(현 상태 박스 본문. **최대 3줄·150자 이내**)",
    "pain": "(핵심 통증 박스 본문. **최대 3줄·150자 이내**)",
    "competitor": "(경쟁사 한계 박스 본문. **최대 3줄·150자 이내**)",
    "conclusionHeadline": "(한 줄 결론 — 60자 이내. 게시물이 아니라 매장 방문·구매 전환 설계가 필요하다는 골조)",
    "conclusionBody": "(보조 설명. **최대 3줄·200자 이내**)",
    "whyChannel": [
...
- **이모지·아이콘 글리프 절대 사용 금지** (🔍 ✨ 🎯 📊 등 모두 금지). PDF 폰트가 렌더하지 못해 깨집니다. 강조가 필요하면 텍스트로만 표현하세요.
- **한자(简体·繁體) 사용 가능.** PDF 본문 폰트는 Noto Sans SC로 한국어/한자 모두 그려집니다. 단 표기 원칙은 아래를 따르세요:
  · 중국 SNS·매체·플랫폼·도시명은 한국어 음역을 1순위로, 필요 시 괄호로 원어 병기: "따종디엔핑(大众点评)", "샤오홍슈(小红书)"
  · 검색 키워드 예시는 한자(简体) 원어로 표기 권장: "韩国美食", "首尔旅行", "明洞购物", "网红咖啡"
  · 본문 흐름은 한국어 위주, 한자는 키워드·해시태그·검색어 예시처럼 정확한 원어 노출이 의미 있는 자리에 사용
