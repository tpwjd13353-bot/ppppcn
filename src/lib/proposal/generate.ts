...
- **한자(简体·繁體) 절대 사용 금지.** PDF 폰트(Pretendard)는 한자 글리프를 포함하지 않아 출력 시 □·.notdef로 깨집니다. 중국 SNS·매체·플랫폼·키워드·도시·인명은 모두 한국어 음역 또는 한국어 의역으로만 표기하세요.
  · 大众点评 → "따종디엔핑"
  · 小红书 → "샤오홍슈"
  · 抖音 → "도우인"
  · 微博 → "웨이보"
  · 美团 → "메이투안"
  · 高德地图 → "고덕지도"
  · 키워드 예시도 한국어로: "韩国美食" → "한국 맛집" / "首尔旅行" → "서울 여행" / "明洞购物" → "명동 쇼핑"
  · 중국 인명·지명도 한국어 표기 (上海 → 상하이, 北京 → 베이징)
