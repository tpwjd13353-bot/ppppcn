      ...
      <View style={styles.pageInner}>
        ...
        >
          ...
          <View style={{ marginTop: 6 }}>
            <Bullet text="매장 등록 · 키워드 최적화 · 카테고리 정합화" />
            <Bullet text="리뷰 · 평점 관리 (응대 표준화 + 부정 리뷰 대응)" />
            <Bullet text="디엔핑 쿠폰 혜택 매장 설정으로 방문 동기 부여" />
          </View>
        </View>
        ...
        >
          ...
          <View style={{ marginTop: 6 }}>
            ...
            <Bullet text='타겟 키워드: "서울 가면 살 화장품", "강남 스킨케어 매장" 등' />
            <Bullet text="콘텐츠 현지화는 KOC에게 기본 가이드 전달 방식 (100% 반영 보장 X — 편차 발생 가능 명시)" />
          </View>
        </View>
        ...
        >
          ...
          <View style={{ marginTop: 6 }}>
            <Bullet text="따종디엔핑: 조회수 · 길찾기 클릭 · 쿠폰 사용 건수" />
            <Bullet text="샤오홍슈: 저장 · 공유 · 좋아요율 (저장 · 공유를 좋아요보다 우선 지표로)" />
            <Bullet
        ...
        <View style={{ marginTop: spacing.md }}>
          ...
          >
            <TimelineStep
              month="0–1개월"
              title="셋업"
              body="디엔핑 매장 등록 · 키워드 · 카테고리 정합화. KOC 시딩 풀 구성."
            />
            <TimelineStep
              month="1–2개월"
              title="집행"
              body="KOC 시딩 본격 집행. 디엔핑 쿠폰 · CPC 광고 동시 운영."
              highlight
            />
            <TimelineStep
              month="2–3개월"
              title="검증"
              body="선행 지표 · 매장 방문 데이터 점검. Phase 2 이행 여부 합의."
            />
          </View>
        </View>
      </View>
