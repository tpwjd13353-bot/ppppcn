    ...
    <Page size="A4" style={styles.page}>
      ...
      <View style={styles.pageInner}>
        ...
        >
          <ExpectBox
            label="기대 가능"
            body="디엔핑 최적화 · 쿠폰 효과로 빠른 매장 방문 반응 기대 가능. Phase 1 기간 내 길찾기 클릭·쿠폰 사용 등 선행 지표 확보."
            tone="primary"
          />
          <ExpectBox
            label="전제 조건"
            body="샤오홍슈 자산화는 콜드스타트 2~3개월 필요. KOC 콘텐츠 편차 발생 가능. 단기 매출 폭발은 약속하지 않습니다."
            tone="warning"
          />
        </View>
